...
jQuery(function ($) {
    ...
    productsPage = (window.location.href.indexOf('index.html') <= -1 && window.location.href.indexOf('.html') > -1)
    if(productsPage) {
        $('.address-social ul').css('background-color', '#bf0000');
        $('.linkedin-text-hvr, .twitter-text-hvr').css('color', '#fff');
    }
    ...
    $(window).on('scroll', function () {
        if ($(this).scrollTop() > 220 || productsPage) { // Set position from top to add class
        ...
        if($(this).scrollTop() > 575 || productsPage){
            $('.address-social ul').css('background-color', '#bf0000');
            $('.linkedin-text-hvr, .twitter-text-hvr').css('color', '#fff');
        } else {
            
            $('.linkedin-text-hvr, .twitter-text-hvr').css('color', '#bf0000');
            $('.address-social ul').css('background-color', '#fff');
        }
    });
    ...
    $(document).on('click', '.scroll-bottom-arrow', function () {
        $('html, body').animate({scrollTop: document.body.scrollHeight}, 800);
        return false;
    });

    if(productsPage === false) {
        //scroll sections
 ...
 $('#js-grid-mosaic-flat1').cubeportfolio({
...
/* ------ CubePortfolio ------ */
  ...
  * ============================================*/
    ...
    $('#js-grid-mosaic-flat-2').cubeportfolio({
        filters: '#js-grid-mosaic-flat-2',
        layoutMode: 'mosaic',
        sortByDimension: true,
        mediaQueries: [{
            width: 1500,
    ...
    $('#js-grid-mosaic-flat-3').cubeportfolio({
        filters: '#js-grid-mosaic-flat-2',
        layoutMode: 'mosaic',
        sortByDimension: true,
        mediaQueries: [{
